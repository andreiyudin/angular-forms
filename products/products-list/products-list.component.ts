...
export class ProductsListComponent implements OnInit {
  ...
  filteredVarieties2: Array<any>;
  filteredProducts: Array<any>;
  filteredProducts2: Array<any>;
  moment = moment;
  toUpdate: boolean;
  ...
  onSkuInfo(productId: number) {
    console.log(productId);
    this.productService.modifyProductById.emit(productId);
  }
  ...
  modelize(){
    ...
    // this.filteredVarieties.forEach((variety2,i,a)=>{
    //   variety2.products = _.filter(this.filteredProducts,{'varietyId':variety2.varietyId, 'breadType': this.filters.breadType2});
