...
export class ProductsFormComponent implements OnInit {
  ...
  constructor(private productsService: ProductsService, private route: ActivatedRoute, private router: Router) {
    this.productsService.modifyProductById.subscribe(
  ...
  // getProductToUpdate() {
  //   this.productsService.modifyProductById.subscribe( productId => {
  ...
  ngOnInit() {
    ...
    console.log('Objetc = ' + this.productToUpdate);
  }
  ...
  setProductsForm(product) {
    ...
    this.productForm.controls['variety'].setValue(product.variety);
    ...
    this.productForm = new FormGroup(
      {
        ...
        variety: new FormControl('1', Validators.required),
