...
export class ProductsService {
  ...
  modifyProductById = new EventEmitter<number>();
  products2: Array<any>;
  ...
  getProductToUpdate(){
    this.products2 = this.getFakeProducts2();
    this.productToUpdate = _.filter(this.products2, {'productId': this.modifyProductById});
